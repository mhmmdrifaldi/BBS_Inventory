...
export default function LandingPage() {
	...
	return (
        ...
        <div className="flex justify-between h-16 items-center max-w-7xl mx-auto px-3 sm:px-6 lg:px-8">
							...
							<div>
								{
									...
									<button
										...
										onClick={()=>{navigate('/data'); setDataSelect(true); setDashboardSelect(false); setBarmaSelect(false); setBarkelSelect(false)}}
									>
										Data Barang
									</button>
								}
							...
							<div>
								{
									...
									<button
										className='px-3 py-2 rounded-md text-sm font-medium text-black hover:bg-teal-800 hover:text-white' 
										onClick={()=>{navigate(''); setBarmaSelect(true); setDataSelect(false); setDashboardSelect(false); setBarkelSelect(false)}}
									>
										Barang Masuk
									</button>
								}
							...
							<div>
								{
									...
									<button
										className='px-3 py-2 rounded-md text-sm font-medium text-black hover:bg-teal-800 hover:text-white' 
										onClick={()=>{navigate(''); setBarkelSelect(true); setDataSelect(false); setDashboardSelect(false); setBarmaSelect(false)}}
									>
										Barang Keluar
									</button>
								}
